...
void and(int entrada1, int entrada2, char * resposta); //25
...
void and(int entrada1, int entrada2, char * str){ //25
    int i;
    char sim[4] = {"SIM"}, nao[4] = {"NAO"};

    if((entrada1==1 && entrada2==0) || (entrada1==0 && entrada2==1)) strcpy(str, nao);
    if((entrada1==1 && entrada2==1) || (entrada1==0 && entrada2==0)) strcpy(str, sim);
}
void NAND(int entrada1, int entrada2, int * resposta){ //26
